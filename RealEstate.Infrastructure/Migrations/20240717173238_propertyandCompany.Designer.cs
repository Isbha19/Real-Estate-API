...
namespace RealEstate.Infrastructure.Migrations
{
    ...
    [Migration("20240717173238_propertyandCompany")]
    partial class propertyandCompany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstate.Domain.Entities.CompanyEntity.Company", b =>
                {
                    ...
                    b.Property<int>("UsedPropertyCounts")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealEstate.Domain.Entities.PropertyEntity.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdatedOn = new DateTime(2024, 7, 17, 21, 32, 37, 518, DateTimeKind.Local).AddTicks(5659),
                            Name = "Apartment"
                        },
                        new
                        {
                            Id = 2,
                            LastUpdatedBy = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdatedOn = new DateTime(2024, 7, 17, 21, 32, 37, 518, DateTimeKind.Local).AddTicks(5677),
                            Name = "Villa"
                        },
                        new
                        {
                            Id = 3,
                            LastUpdatedBy = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdatedOn = new DateTime(2024, 7, 17, 21, 32, 37, 518, DateTimeKind.Local).AddTicks(5679),
                            Name = "Townhouse"
                        },
                        new
                        {
                            Id = 4,
                            LastUpdatedBy = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdatedOn = new DateTime(2024, 7, 17, 21, 32, 37, 518, DateTimeKind.Local).AddTicks(5680),
                            Name = "Penthouse"
                        });
                });
            ...
            modelBuilder.Entity("RealEstate.Domain.Entities.signalr.Connection", b =>
                {
            ...
            modelBuilder.Entity("RealEstate.Domain.Entities.signalr.Group", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RealEstate.Domain.Entities.signalr.Connection", b =>
                {
                    b.HasOne("RealEstate.Domain.Entities.signalr.Group", null)
